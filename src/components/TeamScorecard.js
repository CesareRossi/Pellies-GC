      ...
      <div className="relative overflow-x-auto rounded-xl border border-[#D4AF37]/20 bg-[#0F2C1D]/90 backdrop-blur-md shadow-2xl">
        ...
        <div className="relative bg-[#051A10] border-b border-[#D4AF37]/30">
          <div className="grid grid-cols-13">
            <div className="sticky left-0 z-20 px-2 sm:px-3 py-2 sm:py-3 text-[10px] sm:text-xs font-sans text-white font-bold uppercase tracking-wider border-r border-[#D4AF37]/30 bg-[#051A10] flex items-center justify-center">TEAM</div>
